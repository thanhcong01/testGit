...
@ManagedBean
@ViewScoped
public class CreateInstockDetailReport implements Serializable {
	...
	public void changeGoodsGroup() {
		if(lsGoodsGroup != null && !lsGoodsGroup.isEmpty() && (groupId == null || groupId == 0)){
			groupId = lsGoodsGroup.get(0).getEquipmentsGroupId();
		}
	...
	public void exportStockEquipmentsInvSerial(String stockStatus, String fileDownloadName, String templateFileName) {
		...
		int dataSize = sessionBean.getService().searchStockEquipmentsInvSerialSize(fromSerialTemp, toSerialTemp, SGITemp, null).intValue();
