 ...
 * 
 */
@WebServiceClient(name = "Converter", targetNamespace = "http://service.convert.viettel.com/")
    ...
    extends Service
{
    ...
    private final static QName CONVERTER_QNAME = new QName("http://service.convert.viettel.com/", "Converter");
    ...
    public Converter getConverterPort() {
        return super.getPort(new QName("http://service.convert.viettel.com/", "ConverterPort"), Converter.class);
    }
    ...
    public Converter getConverterPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.convert.viettel.com/", "ConverterPort"), Converter.class, features);
    }
