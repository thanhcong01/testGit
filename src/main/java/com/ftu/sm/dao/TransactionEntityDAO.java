 ...
 * @author E5420
 */
public class TransactionEntityDAO extends GenericDAOHibernate<TransactionEntity, Serializable> {

    public TransactionEntityDAO() {
        super(TransactionEntity.class);
    }

    @Override
    public void saveOrUpdate(TransactionEntity a) {
